...
## Conhecimento Base
- `/root/.openclaw/knowledge/ghl/GHL-API-CAPABILITIES.md` (mapa completo da API, testado 2026-04-09)
- `/root/.openclaw/knowledge/ghl/GHL-CALENDARS-HEADS.md` (calendários, heads, pipelines)
- `/root/.openclaw/knowledge/ghl/ghl-knowledge-base.md` (base geral)
